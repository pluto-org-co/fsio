...
type Filesystem interface {
	...
	Checksum(ctx context.Context, location []string) (checksum string, err error)
	...
	// normalization
	WriteFile(ctx context.Context, location []string, src io.Reader) (finalLocation []string, err error)
